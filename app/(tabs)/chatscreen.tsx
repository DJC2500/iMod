...
function ChatScreen() {
  ...
  // Define message data
  const messages = [
    { id: '1', type: 'received', text: 'Looking forward to the trip.', avatar: require('../assets/images/avatar.png') },
    ...
    { id: '5', type: 'received', text: 'What do you think?', avatar: require('../assets/images/avatar.png') },
